  ...
  #fluidRow(
    fluidRow(
      ...
      column(
        box(
          width = 12,
          absolutePanel(top = 45, left = 345, width = 1550, fixed=TRUE,
          ...
          absolutePanel(class =  "stats",
                        top = 36, left = 0, width = 350, fixed=TRUE,
                        draggable = FALSE, height = "auto", 
                        uiOutput("box_statsPanel"),
          ),

          
          absolutePanel(class =  "panel1",
                        top = 80, right = 40, width = 250, fixed=TRUE,
                        draggable = TRUE, height = "auto",
                        selectInput("maincountry", "Country/Region", c("select to zoom",unique(data_evolution$`Country/Region`))
                                  ),
